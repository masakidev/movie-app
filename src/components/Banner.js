  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col text-white">
        ...
        <h1 className="z-10 text-4xl font-bold mb-2">{movie.title}</h1>
        <div className="z-10 w-20 px-2 flex justify-center items-center gap-1 bg-gray-400 bg-opacity-60 rounded-lg mb-7">
          <BiStar className="text-personalyellow" />
          <p>{movie.vote_average}/10</p>
        </div>
        <p className="z-10">{movie?.overview}</p>
      </div>
    </div>
  );
};
